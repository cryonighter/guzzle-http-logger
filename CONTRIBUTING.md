...
We accept bug reports via issues created on [Github](https://github.com/cryonighter/guzzle-http-logger/issues).
...
- **Always try the [master branch](https://github.com/cryonighter/guzzle-http-logger)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/cryonighter/guzzle-http-logger/pull).
